class Bbapi {
  ...
  static const String serviceEnginnerProductsApproved =
      "$baseUrl/products/products/approved";
  static const String bookingSparepart = "$baseUrl/sparepartsBooking/create";
  static const String getSparepartBooking =
      "$baseUrl/sparepartsBooking/distributor";
  static const String deleteSparepartBooking =
      "$baseUrl/sparepartsBooking/delete";
  static const String serviceenginnerBookingServices =
      "$baseUrl /servicebooking/list";
  static const String serviceenginnerBookingServicesUpdate =
      "$baseUrl /servicebooking/update";
  static const String serviceEnginnerSparepartBooking =
      "$baseUrl/sparepartsBooking/list";
  ...
  static const String getService =
      "$baseUrl/services/getallservices"; //serviceenginner
  ...
  static const String sparepartBookingUpdate =
      "$baseUrl/sparepartsBooking/update";

  static const String distributorProducts =
      "$baseUrl/products/adminAddProducts";
  static const String quantityParts = "$baseUrl/products/products/all";
  static const String requestProduct =
      "$baseUrl/products/distributor/request-product";
  static const String requestAceeptedProducts =
      "$baseUrl/products/requested-products";
  static const String transactionAdd = '$baseUrl/transaction/withdraw';
}
