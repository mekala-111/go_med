            ...
            children: [
              ...
              Text("Description:",
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold)),
              Text(
                widget.sparePart.productDescription ??
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_enteredQuantity != null) {
                        ...
                        final price = (widget.sparePart.price is num)
                            ? (widget.sparePart.price as num).toDouble()
                            : double.tryParse(
                                    widget.sparePart.price.toString()) ??
                                0.0;

                        final totalPrice = _enteredQuantity! * price;
