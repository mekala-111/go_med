...
class ProductProvider extends StateNotifier<Autogenerated> {
  ...
  Future<void> addProduct(String? productName, String? description,
      double? price, String category, File? image, String? SpareParts) async {
    final loadingState = ref.read(loadingProvider.notifier);
  ...
  Future<void> getProducts() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        final Map<String, dynamic> res = json.decode(responseBody);
