...
class WalletDataProvider extends StateNotifier<ServiceModel> {
  ...
  Future<void> addWalletData(
   ...
   String? name
    ...
    print(
        'wallet details data: name:$name,accountnumber:$accountNUmber,ifsc:$ifscNumber,amount:$amount,distributorId:$distributorId');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (snapshot.exists) {
          ...
          if (withdrawAmount > currentWallet) {
            print('❌ Withdraw amount ₹$withdrawAmount exceeds current wallet balance ₹$currentWallet');
          } else {
        ...
        print('wallet data add responce body $serviceDetails');
      } else {
        print(
